...
export type VehicleExpense={id:string;vehicleId:string;category:string;description:string;amount:number;currency?:Currency;exchangeRate?:number;amountZmw?:number;date:string;reference?:string;createdAt:string};
...
{id:"ve1",vehicleId:"1",category:"Clearing",description:"Clearing and handling charges",amount:4200,currency:"ZMW",exchangeRate:1,amountZmw:4200,date:"2026-07-11",reference:"CLR-001",createdAt:"2026-07-11T10:00:00Z"},
{id:"ve2",vehicleId:"1",category:"Registration",description:"Registration and road tax",amount:1800,currency:"ZMW",exchangeRate:1,amountZmw:1800,date:"2026-07-13",reference:"REG-001",createdAt:"2026-07-13T09:00:00Z"},
{id:"ve3",vehicleId:"1",category:"Repairs",description:"Initial service and minor repairs",amount:2500,currency:"ZMW",exchangeRate:1,amountZmw:2500,date:"2026-07-14",reference:"REP-001",createdAt:"2026-07-14T14:00:00Z"}
];
...
export const loadVehicleExpenses=()=>load<VehicleExpense>(EXPENSE_KEY,demoExpenses).map(x=>({...x,currency:x.currency||"ZMW",exchangeRate:x.exchangeRate||1,amountZmw:x.amountZmw??x.amount}));
