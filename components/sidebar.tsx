...
const items = [["/","Dashboard",LayoutDashboard],["/vehicles","Vehicles",Car],["/drivers","Drivers",Users],["/trips","Collection Trips",Route],["#","Expenses",Receipt],["#","Sales",ShoppingCart],["#","Reports",FileBarChart],["#","Settings",Settings]] as const;
