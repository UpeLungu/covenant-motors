...
import {LayoutDashboard,Car,Users,Route,Receipt,ShoppingCart,FileBarChart,Settings,ContactRound} from "lucide-react";
const items=[["/","Dashboard",LayoutDashboard],["/vehicles","Vehicles",Car],["/drivers","Drivers",Users],["/trips","Collection Trips",Route],["/customers","Customers",ContactRound],["/expenses","Expenses",Receipt],["/sales","Sales",ShoppingCart],["#","Reports",FileBarChart],["#","Settings",Settings]] as const;
